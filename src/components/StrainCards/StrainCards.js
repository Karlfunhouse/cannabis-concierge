...
const StrainCards = observer(() => {
  ...
  const noSelectorsAlert = (
    <div className="no-selection-alert">
      <img
        src="/assets/towelie.png"
          ...
          <div className="card-bottom">
            ...
            <h4 className="effects">
              <img
                ...
                className="effect-indicator"
              />
              {strain.effects.negative.length > 0 ? negEffects : "None"}
            </h4>
            <h4 className="effects">
              <img
                src="/assets/taste.png"
                alt="taste"
                className="effect-indicator"
              />
  ...
  return (
    <section className="CardsContainer">
      {weedStore.filterSelectors.length > 0 ? displayCards : noSelectorsAlert}
    </section>
  );
})
